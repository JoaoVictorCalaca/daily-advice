  ...
  if (text != null) {
    return (
      <animated.div style={{...springs}} className='w-10/12 h-auto ease-in-out rounded-xl bg-white shadow-xl py-8 px-14 flex justify-center duration-1000'>
          ...
          <Modal isOpen={modalOpen} onRequestClose={closeModal} style={customStyles} className='w-1/2 h-auto absolute top-1/2 left-1/2 bg-teal-600 p-4 rounded-lg flex flex-col gap-5 items-center justify-center' contentLabel="Successfully copied">
